...
static int evict_cache_slots(RdpgfxClientContext* context, UINT16 MaxCacheSlots, void** CacheSlots)
{
	UINT16 index;
 ...
 */
UINT rdpgfx_send_caps_advertise_pdu(RdpgfxClientContext* context,
                                           const RDPGFX_CAPS_ADVERTISE_PDU* pdu)
{
	...
	*/
	...
	write(fd, Stream_Buffer(s), (UINT32)Stream_Length(s));
	error = CHANNEL_RC_OK;
fail:
	Stream_Free(s, TRUE);
	return error;
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
UINT rdpgfx_send_frame_acknowledge_pdu(RdpgfxClientContext* context,
...
UINT rdpgfx_send_qoe_frame_acknowledge_pdu(RdpgfxClientContext* context,
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
UINT rdpgfx_send_cache_import_offer_pdu(RdpgfxClientContext* context,
 ...
 * @return 0 on success, otherwise a Win32 error code
 */
UINT rdpgfx_get_surface_ids(RdpgfxClientContext* context, UINT16** ppSurfaceIds,
                                   UINT16* count_out)
{
	size_t count;
	size_t index;
